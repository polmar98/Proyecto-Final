...
function Detail() {
  ...
  for (let i = 0; i < hotelData.stars; i++) {
    stars.push(
      <RiStarSFill
        key={i}
        className="text-yellow-500 text-3xl mr-1 inline-flex"
      />
    );
  }
  ...
  return (
    <>
      <div className="container mx-auto p-4">
        ...
        <h2 className="text-5xl font-bold mb-4 text-left mt-20 fontPoppins">
          {tour.title}
        </h2>
        <div className="grid grid-cols-3 gap-4 fontPoppins">
          <div className="text-left mt-20 col-span-1">
            <h2 className="text-xl font-semibold text-justify mr-10">
              {tour.description}
            </h2>
        ...
        <h2 className="text-3xl font-bold mb-4 mt-12 text-left fontPoppins">
          Actividades
        </h2>
        <div className="grid grid-cols-3 gap-4 mt-8">
